...
// When the above code is converted to an arrow function, the following error occurs: Uncaught SyntaxError: Malformed arrow function parameter list
...
// TODO: After viewing the previous console.log(), return the code to a working state.
// When converted to an arrow function, the above prototype function produces only the string portion and can't access this.name ---> Hi, my name is 
...
// The scope is actually the window object, because arrow functions do not bind "this."

// 3. Explain why "this" is different when an arrow function is used.
// "this" is different when an arrow function is used because "this" bubbles up to the global window object, since it's the nearest enclosing scope.
