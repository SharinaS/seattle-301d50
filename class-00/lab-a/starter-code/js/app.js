...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT --> Let is assigned only to the block of code that it's in. The variable, rando, in the console.log is what threw the error, because it is no longer defined once outside the displayPics function.
